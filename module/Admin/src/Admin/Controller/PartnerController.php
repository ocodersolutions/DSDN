...
class PartnerController extends OcoderActionController
{
    public function init()
    {
        // OPTIONS
        $this->_options['modelTable'] = 'Admin\Model\PartnerTable';
        $this->_options['formName'] = 'formAdminPartner';
    ...
    public function filterAction() 
    {
        ...
        $this->goAction('admin', array('controller' => 'partner', 'action' => 'index'));
    }
    ...
    public function formAction() 
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($action == 'save-close')
                $this->goAction('admin', array('controller' => 'partner'));
            if ($action == 'save-new')
                $this->goAction('admin', array('controller' => 'partner', 'action' => 'form'));
            if ($action == 'save')
                $this->goAction('admin', array('controller' => 'partner', 'action' => 'form', 'id' => $id));
            //            }
        }
