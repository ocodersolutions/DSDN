...
class CareerController extends OcoderBaseController {

    public function init() {
        // OPTIONS
        $this->_options['tableName'] = TABLE_CAREERS;
        $this->_options['modelTable'] = 'Admin\Model\CareerTable';
        $this->_options['formName'] = 'formAdminCareer';
...
//                $this->_params['data'] = $myForm->getData(FormInterface::VALUES_AS_ARRAY);
            ...
            $this->_params['data']['content_lang'] = json_encode(
                    array(
                        'content_en' => trim($this->_params['data']['content_en']) ? $this->_params['data']['content_en'] : $this->_params['data']['content'],
                        'content_jp' => trim($this->_params['data']['content_jp']) ? $this->_params['data']['content_jp'] : $this->_params['data']['content'],
            ));
